...
print(f"DEBUG: API Key used is '{os.environ.get('OPENWEATHER_API_KEY')}'")
...
if __name__ == "__main__":
    ...
    os.environ["GCP_PROJECT_ID"] = "weather-data-pipeline-project" # REPLACE
    os.environ["GCS_BUCKET_NAME"] = "weather-data-pipeline-project-weather-data" # REPLACE
    os.environ["BIGQUERY_DATASET_ID"] = "weather_data"
    os.environ["BIGQUERY_TABLE_ID"] = "current_weather"
    os.environ["OPENWEATHER_API_KEY"] = "02762022e018d8d785890124cf197d16c" # <<-- PUT YOUR ACTUAL KEY HERE, IN QUOTES
